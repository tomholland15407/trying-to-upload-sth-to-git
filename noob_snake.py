...
FPS = 40  # Increased for smoother input
...
# Button setup
font = pygame.font.SysFont('Comic Sans', 19)
buttons = {
    "Start": pygame.Rect(10, HEIGHT + 10, 80, 50),
    "Pause": pygame.Rect(100, HEIGHT + 10, 80, 50),
    "Resume": pygame.Rect(190, HEIGHT + 10, 80, 50),
    "Stop": pygame.Rect(280, HEIGHT + 10, 80, 50),
}
